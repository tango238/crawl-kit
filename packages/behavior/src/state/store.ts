...
/**
 * Persists a run's SiteStructure under `.e2e/runs/<runId>.yaml`.
 */
...
/**
 * Loads all feedback items from `.e2e/feedback/*.feedback.yaml` (one file per item).
...
/**
 * Persists a single feedback item to `.e2e/feedback/<id>.feedback.yaml`.
...
/**
 * Loads all known-findings entries from `.e2e/known-findings/*.yaml`.
